...
describe("ajx.post function", () => {
    ...
    describe("ajx.post for '/204' with string 'hello' and no option:", () => {
        let responseBody = null
        let requests = null

        before(co.wrap(function* () {
            responseBody = yield ajx.post(server.url("/204"), "hello")
        ...
        describe("The server", () => {
            it("should receive a POST request", () => {
    ...
    describe("ajx.post for '/204' with object '{hello: \"world\"}' and no option:", () => {
        let responseBody = null
        let requests = null

        before(co.wrap(function* () {
            responseBody = yield ajx.post(server.url("/204"), {hello: "world"})
            requests = server.result()
        }))
    ...
    describe("ajx.post for '/204' with a FormData object and no option:", () => {
        let responseBody = null
        let requests = null
        ...
        before(co.wrap(function* () {
            ...
            responseBody = yield ajx.post(server.url("/204"), formData)
            requests = server.result()
        }))
    ...
    describe("ajx.post for '/204' with a HTMLFormElement object and no option:", () => {
        let responseBody = null
        let requests = null
        ...
        before(co.wrap(function* () {
            ...
            responseBody = yield ajx.post(server.url("/204"), form)
            requests = server.result()
        }))
